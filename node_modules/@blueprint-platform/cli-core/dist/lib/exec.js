...
exports.flagsToArgs = flagsToArgs;
...
function run(command, args, cwd, env) {
    return new Promise((resolve, reject) => {
        (0, node_child_process_1.execFile)(command, args, { cwd, env, shell: process.platform === 'win32', maxBuffer: 10 * 1024 * 1024 }, (error, stdout, stderr) => {
            if (error) {
 ...
 */
function runGenerator(cwd, generator, args, registry) {
    return run('npx', ['nx', 'g', generator, ...args, '--no-interactive', ...registryArgs(registry)], cwd, cleanEnv());
}
/** `npm view <spec> [args]`, with the same scope-registry-override handling. */
function npmView(spec, args, registry) {
